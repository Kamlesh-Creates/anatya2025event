      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-2xl rounded-2xl p-8 text-center">
          ...
          <div className="space-y-4">
            <Link 
              href="/" 
              className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-full hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105 shadow-lg"
            >
            ...
            <Link 
              href="/about" 
              className="w-full inline-flex items-center justify-center px-6 py-3 border-2 border-blue-600 text-blue-600 dark:text-blue-400 dark:border-blue-400 font-semibold rounded-full hover:bg-blue-600 hover:text-white dark:hover:bg-blue-400 dark:hover:text-gray-900 transition-colors"
            >
              Learn More About Anantya
            </Link>
          </div>
        </div>
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 shadow-lg">
            ...
            <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <span>Event details will be shared before March 15, 2025</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <span>Join 1000+ other participants</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
            Spread the word about Anantya 2025!
          </p>
